    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strategy_name', models.CharField(default='Bola de Neve', max_length=80)),
                ('total_remaining', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
